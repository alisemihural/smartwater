...
void loop() {
  ...
  if (serial.available()>0)
  {
    ...
    Firebase.setBool("WaterMeter2",true);
    Firebase.setInt("Debi2", debiArduino);
    Firebase.setInt("Total2",totalML);
    Firebase.setInt("Total2day",totalML);
    Firebase.setFloat("Hiz2",akisHizi);
    
  } else{
    Firebase.setBool("WaterMeter2",false);
  }
